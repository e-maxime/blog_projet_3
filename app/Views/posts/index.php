<div class="row">
    <div class="col-lg-12">
        <p style="text-align: justify; font-size: 1.1em;">
             <img src="../public/images/book.jpg" style="width:30%; float:right; margin-left: 2%; margin-top: 2%;">
            <span style="font-size: 3em; font-weight: bold; color: #00001a;">V</span>enez découvrir mon nouveau roman <em>Un billet simple pour l'Alaska</em>.<br/>
            ...
            <h3><span style="font-weight: bold; color: #00001a;">Bonne lecture à tous !</span></h3>
        </p>
    </div>
</div>
